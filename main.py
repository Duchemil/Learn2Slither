...
def main():
    ...
    parser.add_argument("-max", type=int, default=0, help="Show max score game in play mode (default: 100)")
    parser.add_argument("-g", "-gui", "--gui", dest="gui", action="store_true", help="Launch GUI lobby")
    ...
    if args.mode == "train":
        ...
        if args.max:
            print("Showing max score games, it may takes a few seconds to find the max game...")
            play_multiple_games(q_table, verbose=args.verbose, num_games=args.max)
        else:
